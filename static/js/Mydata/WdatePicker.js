...
function B() {
    ...
    var A = {
        ...
        show: function() {
            ...
            this.dd.style.boxShadow = '-2px 2px 10px #666';
			this.dd.style.backgroundColor = '#fff';
			this.dd.style.height = '222px';
			this.dd.style.borderRadius = '2px';
			this.dd.className = 'dataBox';
            P(this.dd, "block");
